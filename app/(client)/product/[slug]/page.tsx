    ...
    <Container className="py-10 flex flex-col md:flex-row gap-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col gap-5">
        ...
        <div className="flex items-center gap-2.5 lg:gap-5">
          ...
          />
          <button className="border-2 border-darkColor/30 text-darkColor/60 px-2.5 py-1.5 rounded-md hover:bg-darkColor hover:text-darkColor hoverEffect">
            <Heart className="h-5 w-5" />
          </button>
        </div>
        <ProductCharacteristics product={product} />
        <div className="flex flex-wrap items-center justify-between gap-2.5 border-b border-b-gray- py-5 -mt-2">
        ...
        <div className="flex flex-wrap items-center gap-5">
          <div className="border border-darkBlue/20 text-center p-3 hover:border-darkColor rounded-md hoverEffect">
